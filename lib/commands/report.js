...
const { requireInit, readJson, addLog, today, MOLDS_FILE, REPAIR_FILE, MAINTENANCE_FILE, CONFIG_FILE, TRANSACTIONS_FILE } = require('../utils');
const warnModule = require('./warn');
const costModule = require('./report-cost');
...
function buildSummaryData() {
  ...
  var monthlyOutCount = (readJson(TRANSACTIONS_FILE) || []).filter(function (t) { return t.outDate && t.outDate.startsWith(thisMonth); }).length;
...
exports.reportCost = costModule.reportCost;
